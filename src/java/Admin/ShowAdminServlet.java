...
public class ShowAdminServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            DBCollection col = db.getCollection("Admins");

            // Find all documents in the collection
            DBCursor cursor = col.find();

            pw.println("<div class='container'>");
            pw.println("<h1>Admin Data</h1>");
            pw.println("<table class='table'>");
            pw.println("<thead>");
            pw.println("<tr><th>Name</th><th>Email</th><th>Department</th><th>Position</th><th>DOB</th><th>Phone Number</th><th>Gender</th><th>City</th><th>Update</th><th>Delete</th></tr>");
            pw.println("</thead>");
            pw.println("<tbody>");
