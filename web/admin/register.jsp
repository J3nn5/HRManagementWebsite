                ...
                <tr>
                    ...
                    <td>
                        <select class = "custom-select" name="department">
                            ...
                            <option value="thietke">Phong Thiet Ke</option>
                            <option value="nhansu">Phong Nhan Su</option>
                            <option value="taichinh">Phong Tai Chinh</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select class = "custom-select" name="position">
                            <option value="director">Giam Doc</option>
                            <option value="head_of_department">Truong Phong</option>
                            <option value="manager/leader">Quan Ly</option>
